...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/admin/quiz/QuizOverview': RouteRecordInfo<'/admin/quiz/QuizOverview', '/admin/quiz/QuizOverview', Record<never, never>, Record<never, never>>,
    '/admin/quiz/QuizQuestionForm': RouteRecordInfo<'/admin/quiz/QuizQuestionForm', '/admin/quiz/QuizQuestionForm', Record<never, never>, Record<never, never>>,
